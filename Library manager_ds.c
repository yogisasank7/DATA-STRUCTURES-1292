...
void greetings(){
    ...
    printf("\t\t\t     *                                      *\n");
    printf("\t\t\t     *                                      *\n");
    printf("\t\t\t     *     Mallareddy clg,Telangana,India   *\n");
    printf("\t\t\t     *     Email: sasankyogi@gmail.com      *\n");
    printf("\t\t\t     *     Contact:9182773857*\n");
    printf("\t\t\t     *                                      *\n");
    printf("\t\t\t     ****************************************\n");
...
struct book *initialize_lib(struct book *start){
    ...
    new_book1->next=NULL;
    start_lib=new_book1;
    strcpy(new_book1->name,"Nenu (Atmakatha in Telugu) ");
    strcpy(new_book1->author,"Brahmanandam ");
    new_book1->id=101;
    ptr=new_book1;
